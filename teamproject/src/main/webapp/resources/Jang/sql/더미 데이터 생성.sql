...
values(0, 0, '1234', 'sysname', 'sysnick', 'sys@hot.com', sysdate);

INSERT INTO tbl_board (b_no, title, content, writer, b_type, regdate, updatedate) VALUES (seq_board.nextval, '공지사항1', '<h2>2024년 차박 캠핑 안내</h2><p>안녕하세요, 사용자 여러분!</p><p>2024년 차박 캠핑을 안내드립니다. 이번 캠핑에는 다음과 같은 프로그램이 준비되어 있습니다:</p><ul><li>차박 체험</li><li>캠핑 요리</li><li>경품 추첨</li></ul><p>참여 신청은 <a href="http://example.com/car-camping">여기</a>에서 해주시기 바랍니다.</p><p>감사합니다.</p><p>작성자: 운영팀</p>', 0, 1, sysdate, sysdate);
INSERT INTO tbl_board (b_no, title, content, writer, b_type, regdate, updatedate) VALUES (seq_board.nextval, '공지사항2', '<h2>2024년 글램핑 행사 안내</h2><p>안녕하세요, 사용자 여러분!</p><p>2024년 글램핑 행사를 안내드립니다. 이번 행사에는 다음과 같은 프로그램이 준비되어 있습니다:</p><ul><li>럭셔리 글램핑</li><li>별 관측</li><li>경품 추첨</li></ul><p>참여 신청은 <a href="http://example.com/glamping">여기</a>에서 해주시기 바랍니다.</p><p>감사합니다.</p><p>작성자: 운영팀</p>', 0, 1, sysdate, sysdate);
INSERT INTO tbl_board (b_no, title, content, writer, b_type, regdate, updatedate) VALUES (seq_board.nextval, '공지사항3', '<h2>2024년 캠핑 축제 안내</h2><p>안녕하세요, 사용자 여러분!</p><p>2024년 캠핑 축제를 안내드립니다. 이번 축제에는 다음과 같은 프로그램이 준비되어 있습니다:</p><ul><li>캠핑 장비 전시</li><li>야외 게임</li><li>경품 추첨</li></ul><p>참여 신청은 <a href="http://example.com/camping-festival">여기</a>에서 해주시기 바랍니다.</p><p>감사합니다.</p><p>작성자: 운영팀</p>', 0, 1, sysdate, sysdate);
INSERT INTO tbl_board (b_no, title, content, writer, b_type, regdate, updatedate) VALUES (seq_board.nextval, '공지사항4', '<h2>2024년 여름 차박 캠핑</h2><p>안녕하세요, 사용자 여러분!</p><p>2024년 여름 차박 캠핑을 안내드립니다. 이번 캠핑에는 다음과 같은 프로그램이 준비되어 있습니다:</p><ul><li>차박 요리 교실</li><li>야외 영화 상영</li><li>경품 추첨</li></ul><p>참여 신청은 <a href="http://example.com/summer-car-camping">여기</a>에서 해주시기 바랍니다.</p><p>감사합니다.</p><p>작성자: 운영팀</p>', 0, 1, sysdate, sysdate);
INSERT INTO tbl_board (b_no, title, content, writer, b_type, regdate, updatedate) VALUES (seq_board.nextval, '공지사항5', '<h2>2024년 가을 글램핑</h2><p>안녕하세요, 사용자 여러분!</p><p>2024년 가을 글램핑을 안내드립니다. 이번 글램핑에는 다음과 같은 프로그램이 준비되어 있습니다:</p><ul><li>단풍 구경</li><li>럭셔리 캠핑</li><li>경품 추첨</li></ul><p>참여 신청은 <a href="http://example.com/fall-glamping">여기</a>에서 해주시기 바랍니다.</p><p>감사합니다.</p><p>작성자: 운영팀</p>', 0, 1, sysdate, sysdate);
INSERT INTO tbl_board (b_no, title, content, writer, b_type, regdate, updatedate) VALUES (seq_board.nextval, '공지사항6', '<h2>2024년 겨울 캠핑</h2><p>안녕하세요, 사용자 여러분!</p><p>2024년 겨울 캠핑을 안내드립니다. 이번 캠핑에는 다음과 같은 프로그램이 준비되어 있습니다:</p><ul><li>겨울 캠프파이어</li><li>눈놀이</li><li>경품 추첨</li></ul><p>참여 신청은 <a href="http://example.com/winter-camping">여기</a>에서 해주시기 바랍니다.</p><p>감사합니다.</p><p>작성자: 운영팀</p>', 0, 1, sysdate, sysdate);
INSERT INTO tbl_board (b_no, title, content, writer, b_type, regdate, updatedate) VALUES (seq_board.nextval, '공지사항7', '<h2>2024년 봄 차박 캠핑</h2><p>안녕하세요, 사용자 여러분!</p><p>2024년 봄 차박 캠핑을 안내드립니다. 이번 캠핑에는 다음과 같은 프로그램이 준비되어 있습니다:</p><ul><li>봄꽃 구경</li><li>캠핑 장비 체험</li><li>경품 추첨</li></ul><p>참여 신청은 <a href="http://example.com/spring-car-camping">여기</a>에서 해주시기 바랍니다.</p><p>감사합니다.</p><p>작성자: 운영팀</p>', 0, 1, sysdate, sysdate);
INSERT INTO tbl_board (b_no, title, content, writer, b_type, regdate, updatedate) VALUES (seq_board.nextval, '공지사항8', '<h2>2024년 차박 이벤트</h2><p>안녕하세요, 사용자 여러분!</p><p>2024년 차박 이벤트를 안내드립니다. 이번 이벤트에는 다음과 같은 프로그램이 준비되어 있습니다:</p><ul><li>차박 요리 대회</li><li>자연 탐험</li><li>경품 추첨</li></ul><p>참여 신청은 <a href="http://example.com/car-event">여기</a>에서 해주시기 바랍니다.</p><p>감사합니다.</p><p>작성자: 운영팀</p>', 0, 1, sysdate, sysdate);
INSERT INTO tbl_board (b_no, title, content, writer, b_type, regdate, updatedate) VALUES (seq_board.nextval, '공지사항9', '<h2>2024년 글램핑 파티</h2><p>안녕하세요, 사용자 여러분!</p><p>2024년 글램핑 파티를 안내드립니다. 이번 파티에는 다음과 같은 프로그램이 준비되어 있습니다:</p><ul><li>럭셔리 파티</li><li>바비큐 파티</li><li>경품 추첨</li></ul><p>참여 신청은 <a href="http://example.com/glamping-party">여기</a>에서 해주시기 바랍니다.</p><p>감사합니다.</p><p>작성자: 운영팀</p>', 0, 1, sysdate, sysdate);
INSERT INTO tbl_board (b_no, title, content, writer, b_type, regdate, updatedate) VALUES (seq_board.nextval, '공지사항10', '<h2>2024년 여름 캠핑</h2><p>안녕하세요, 사용자 여러분!</p><p>2024년 여름 캠핑을 안내드립니다. 이번 캠핑에는 다음과 같은 프로그램이 준비되어 있습니다:</p><ul><li>여름 수영장</li><li>야외 바베큐</li><li>경품 추첨</li></ul><p>참여 신청은 <a href="http://example.com/summer-camping">여기</a>에서 해주시기 바랍니다.</p><p>감사합니다.</p><p>작성자: 운영팀</p>', 0, 1, sysdate, sysdate);
INSERT INTO tbl_board (b_no, title, content, writer, b_type, regdate, updatedate)
...
SET SERVEROUTPUT ON
BEGIN
    FOR rec IN (SELECT * FROM tbl_board) LOOP
        DBMS_OUTPUT.PUT_LINE('INSERT INTO destination_table (b_no, title, content, writer, b_type, regdate, updatedate) VALUES ('
                             || rec.b_no || ', ' 
                             || rec.title || ', ' 
                             || rec.content || ', ' 
                             || rec.writer || ', ' 
